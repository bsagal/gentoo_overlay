...
# $Header: /var/cvsroot/gentoo-x86/games-board/jrisk/jrisk-1.0.9.8.ebuild,v 1.1 2008/10/08 16:04:10 mr_bones_ Exp $

inherit eutils java-pkg-2 java-ant-2 games

DESCRIPTION="The well-known board game, written in java"
HOMEPAGE="http://jrisk.sourceforge.net"
SRC_URI="mirror://sourceforge/domination/Domination/${PV}/Domination_${PV}.zip"
